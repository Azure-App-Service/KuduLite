...
namespace Kudu.Services.ServiceHookHandlers
{
    ...
    public class GitHubCompatHandler : ServiceHookHandlerBase
    {
        ...
        protected virtual bool IsNoop(HttpRequest request, JObject payload, string targetBranch)
        { 
            string newRef = payload.Value<string>("after");
            return IsDeleteCommit(newRef);
        }

        protected virtual bool ParserMatches(HttpRequest request, JObject payload, string targetBranch)
        {
