...
namespace Kudu.Services.Web.Pages.NewUI.DebugConsole2
{
    ...
    public class DebugConsole2Controller : Controller
    {
        public ActionResult Index()
        {
            ...
            return View($"~/Pages/NewUI/DebugConsole2/{os}Console.cshtml");
        }

        public ActionResult LinuxConsole()
        {
            return View($"~/Pages/NewUI/DebugConsole2/LinuxConsole.cshtml");
        }

        public ActionResult WindowsConsole()
        {
            return View($"~/Pages/NewUI/DebugConsole2/WindowsConsole.cshtml");
        }
